...
//        static weak var delegate: NSViewController? = nil
//    }
//    
//    public class func sharedInstance(delegate:NSViewController)-> GC {
...
//    }
//    
//    class var delegate: NSViewController {
//        get {
//            do {
...
//    }
//    
//    class func getlocalPlayerInformation(completion completionTuple: (playerInformationTuple:(playerID:String,alias:String,profilPhoto:NSImage?)?) -> ()) {
//        
...
//            (image, error) in
//            
//            var playerInformationTuple:(playerID:String,alias:String,profilPhoto:NSImage?)
...
//        #endif
//        
//        var delegeteParent:NSViewController? = GC.delegate.parentViewController
//        if delegeteParent == nil {
//            delegeteParent = GC.delegate
//        }
//        delegeteParent!.presentViewControllerAsModalWindow(gc)
...
//        if completion != nil {
//            //completion!(result: NSApplication.sharedApplication().openURL(NSURL(string: "gamecenter:")!))
//        }
//    }
//    
...
//            
//            var delegeteParent:NSViewController? = delegatVC.parentViewController
//            if delegeteParent == nil {
//                delegeteParent = delegatVC
//            }
//            delegeteParent!.presentViewControllerAsModalWindow(controlllerGKMatch!)
...
//    }
//    
//    private func getDelegate() throws -> NSViewController {
...
//                    delegateVC.presentViewControllerAsModalWindow(gcVC)
...
//            delegeteParent = GC.delegate
//        }
//        delegeteParent!.presentViewControllerAsModalWindow(gkmv)
